...
screen about():
    ...
    frame:
        ...
        vbox:
            ...
            text "ОБ ИГРЕ" size 50 color "#e6ff00"
            text "Home-Through-the-Night"
            text "Версия 1.0" size 25
            text "Автор:" size 25
            text "https://github.com/" size 35
            text "Username-Andrey-is-available" size 40 color "#8a2be2"
            text "Репозиторий набирает 10 stars," size 25
            text "выходит патч, если 20 — новая новелла." size 25
            text "Ren'Py лайк душевный ловят, орлы" size 25
...
screen preferences():
    ...
    frame:
        ...
        vbox:
            ...
            textbutton "  Удалить все сохранения":
...
screen gameplay_hud():
    ...
    frame:
        ...
        vbox:
            ...
            text "Время: [format_game_time(game_minutes)]" size 23 color "#f2f2f2"
            text "Деньги: [money] ₽" size 21 color "#d9ffd9"

            text "Инвентарь" size 20 color "#f2f2f2"
                    ...
                    frame:
                        ...
                        if i < len(inventory):
                            ...
                            if icon:
                                ...
                                text "[item_name]" size 14 xalign 0.5 yalign 0.95
                            else:
                                text "[item_name]" size 16 xalign 0.5 yalign 0.5 text_align 0.5
                        else:
