...
label day6_final_resolution:
    if day5_oldwoman_hint and empathy > 8:
        ...
        if stress < 7:
            menu:
                ...
                "Ничего не трогать и ехать в клинику сразу, ведь непонятно когда Он вернётся.":
    ...
    call show_endgame_secrets("day6_fragile_balance") from _call_show_endgame_secrets_day6_fragile_balance
    $ renpy.full_restart()
...
label ending_good_lina_doll:
    ...
    call show_endgame_secrets("ending_good_lina_doll") from _call_show_endgame_secrets_ending_good_lina_doll
    $ renpy.full_restart()
