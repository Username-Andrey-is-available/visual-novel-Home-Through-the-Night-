...
label show_endgame_secrets(ending_id=""):
    $ summary_lines = build_endgame_secret_lines(ending_id)
    call screen ending_secrets(summary_lines)
    return
...
label ending_burnout:
    ...
    call show_endgame_secrets("ending_burnout") from _call_show_endgame_secrets_ending_burnout
    $ renpy.full_restart()
...
label ending_lost_night:
    ...
    call show_endgame_secrets("ending_lost_night") from _call_show_endgame_secrets_ending_lost_night
    $ renpy.full_restart()
...
label ending_prison:
    ...
    call show_endgame_secrets("ending_prison") from _call_show_endgame_secrets_ending_prison
    $ renpy.full_restart()
...
label ending_faceless_function:
    ...
    call show_endgame_secrets("ending_faceless_function") from _call_show_endgame_secrets_ending_faceless_function
    $ renpy.full_restart()
...
label ending_suicide:
    ...
    call show_endgame_secrets("ending_suicide") from _call_show_endgame_secrets_ending_suicide
    $ renpy.full_restart()
...
label ending_clinic:
    ...
    call show_endgame_secrets("ending_clinic") from _call_show_endgame_secrets_ending_clinic
    $ renpy.full_restart()
...
label ending_day6_hook:
    ...
    call show_endgame_secrets("ending_day6_hook") from _call_show_endgame_secrets_ending_day6_hook
    $ renpy.full_restart()
