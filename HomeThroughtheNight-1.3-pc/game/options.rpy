...
define config.name = _("Home Through the Night")
...
define build.name = "HomeThroughtheNight"
...
define config.save_directory = "HomeThroughtheNight-1773126015"
...
init -1 python:
    for _icon_candidate in ("icon.ico", "gui/window_icon.ico", "gui/window_icon.png"):
        if renpy.loadable(_icon_candidate):
            config.window_icon = _icon_candidate
            break
